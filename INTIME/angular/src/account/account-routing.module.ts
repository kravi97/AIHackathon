        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loadChildren: () =>
                            import('./login/validate-passwordless-login.module').then((m) => m.ValidatePasswordlessLoginModule),
                    },
                    {
                        path: 'passwordless-login',
                        loadChildren: () =>
                            import('./login/passwordless-login.module').then((m) => m.PasswordlessLoginModule),
                    },
                    {
