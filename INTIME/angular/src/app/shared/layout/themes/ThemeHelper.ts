export class ThemeHelper {
    ...
    public static getDesktopFixedFooter(): string {
        return abp.setting.get(ThemeHelper.getTheme() + '.App.UiManagement.Footer.DesktopFixedFooter')?.toLowerCase();
    }

    public static getMobileFixedFooter(): string {
        return abp.setting.get(ThemeHelper.getTheme() + '.App.UiManagement.Footer.MobileFixedFooter')?.toLowerCase();
    }
}
