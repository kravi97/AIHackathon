...
export class DefaultThemeAssetContributor implements IThemeAssetContributor {
    ...
    public getFooterStyle(): string {
        return 'footer p-4 d-flex flex-lg-column';
    }
    ...
    getBodyAttributes(): NameValuePair[] {
        ...
        {
            name: 'data-kt-app-footer-fixed',
            value: ThemeHelper.getDesktopFixedFooter()
        },
        {
            name: 'data-kt-app-footer-fixed-mobile',
            value: ThemeHelper.getMobileFixedFooter()
        }];
    }
