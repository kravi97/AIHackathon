...
{
    public class SubscriptionPaymentRepository : INTIMERepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<INTIMEDbContext> dbContextProvider)
