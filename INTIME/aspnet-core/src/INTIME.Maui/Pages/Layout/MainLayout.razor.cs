...
using INTIME.Maui.Core.Helpers;
using INTIME.Maui.Core.Localization;
using INTIME.Maui.Services.Account;
using INTIME.Maui.Services.Navigation;
using INTIME.Maui.Services.Tenants;
using INTIME.Maui.Services.UI;
using Plugin.Connectivity;

#if ANDROID
using INTIME.Maui.Core.Platforms.Android.HttpClient;
#endif
#if IOS
using INTIME.Maui.Core.Platforms.iOS.HttpClient;
#endif

namespace INTIME.Maui.Pages.Layout
{
