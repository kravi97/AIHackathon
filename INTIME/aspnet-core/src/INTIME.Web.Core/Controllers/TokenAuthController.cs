...
using INTIME.Authentication.TwoFactor.Google;
...
using INTIME.Web.Models.TokenAuth;
using INTIME.Authorization.Impersonation;
using INTIME.Authorization.Roles;
using INTIME.Configuration;
using INTIME.Identity;
using INTIME.Net.Sms;
using INTIME.Notifications;
using INTIME.Security.Recaptcha;
using INTIME.Web.Authentication.External;
using INTIME.Web.Common;
using INTIME.Authorization.Delegation;
using Abp.Runtime.Validation;
using INTIME.Authorization.PasswordlessLogin;

namespace INTIME.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : INTIMEControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(INTIMEConsts.DateTimeOffsetFormat));
