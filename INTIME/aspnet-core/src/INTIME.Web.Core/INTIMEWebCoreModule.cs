...
using INTIME.Authentication.TwoFactor;
using INTIME.Chat;
using INTIME.Configuration;
using INTIME.EntityFrameworkCore;
using INTIME.Startup;
using INTIME.Web.Authentication.JwtBearer;
using INTIME.Web.Authentication.TwoFactor;
using INTIME.Web.Chat.SignalR;
using INTIME.Web.Common;
using INTIME.Web.Configuration;
using INTIME.Web.DashboardCustomization;
using Abp.Extensions;
using Abp.HtmlSanitizer;
using Abp.HtmlSanitizer.Configuration;
using INTIME.Authorization.Accounts;

namespace INTIME.Web
{
    [DependsOn(
        typeof(INTIMEApplicationModule),
        typeof(INTIMEEntityFrameworkCoreModule),
    ...
    public class INTIMEWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public INTIMEWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(INTIMEApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(INTIMEWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(INTIMEWebCoreModule).Assembly);
        }
