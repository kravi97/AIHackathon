...
namespace INTIME.Web.Public.Startup
{
    [DependsOn(
        typeof(INTIMEWebCoreModule)
    )]
    public class INTIMEWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public INTIMEWebFrontEndModule(IWebHostEnvironment env, INTIMEEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(INTIMEWebFrontEndModule).GetAssembly());
        }
    }
}
