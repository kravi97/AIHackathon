...
using INTIME.Url;
using INTIME.Web.Public.Startup;
using INTIME.Web.Session;
using INTIME.Web.UiCustomization;

namespace INTIME.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : INTIMEViewComponent
    {
