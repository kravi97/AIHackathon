...
using INTIME.Authentication;
using INTIME.DashboardCustomization;
...
namespace INTIME.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!INTIMEConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        INTIMEConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        INTIMEDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        INTIMEDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = INTIMEDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{INTIMEDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{INTIMEDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = INTIMEDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = INTIMEDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    INTIMEDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = INTIMEDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{INTIMEDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{INTIMEDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = INTIMEDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = INTIMEDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    INTIMEDashboardCustomizationConsts.Widgets.Tenant
        ...
        {
            return new LocalizableString(name, INTIMEConsts.LocalizationSourceName);
        }
    }
}
