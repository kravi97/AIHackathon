...
using INTIME.Authorization.Ldap;
using INTIME.Authorization.Roles;
using INTIME.Authorization.Users;
using INTIME.Chat;
using INTIME.Configuration;
using INTIME.DashboardCustomization.Definitions;
using INTIME.Debugging;
using INTIME.DynamicEntityProperties;
using INTIME.Features;
using INTIME.Friendships;
using INTIME.Friendships.Cache;
using INTIME.Localization;
using INTIME.MultiTenancy;
using INTIME.Net.Emailing;
using INTIME.Notifications;
using INTIME.WebHooks;

namespace INTIME
{
    [DependsOn(
        typeof(INTIMECoreSharedModule),
    ...
    public class INTIMECoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            INTIMELocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = INTIMEConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, INTIMEMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<INTIMESmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(INTIMECoreModule).GetAssembly());
        }
