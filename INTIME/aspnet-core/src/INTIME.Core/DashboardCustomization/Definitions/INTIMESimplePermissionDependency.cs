...
/// </summary>
public class INTIMESimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public INTIMESimplePermissionDependency()
    {
    ...
    public INTIMESimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public INTIMESimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
