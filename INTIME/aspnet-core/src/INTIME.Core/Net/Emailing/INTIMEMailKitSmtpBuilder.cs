...
{
    public class INTIMEMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public INTIMEMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(INTIMEConsts.LocalizationSourceName, name);
        }
