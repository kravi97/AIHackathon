...
namespace INTIME.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : INTIMEServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("INTIME", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
