...
using INTIME.Authentication.PasswordlessLogin;
using INTIME.Authorization.PasswordlessLogin;

namespace INTIME.Authorization.Accounts
{
    public class AccountAppService : INTIMEAppServiceBase, IAccountAppService
    {
        ...
        private async Task SendSmsPasswordlessCode(string phoneNumber)
        {
            ...
            var message = string.Format(L("PasswordlessLogin_SmsMessage", INTIMEConsts.ProductName, code));
