...
using INTIME.Authorization.Users.Profile.Cache;
using INTIME.Authorization.Users.Profile.Dto;
using INTIME.Configuration;
using INTIME.Friendships;
using INTIME.Gdpr;
using INTIME.Net.Sms;
using INTIME.Security;
using INTIME.Storage;
using INTIME.Timing;
using INTIME.Url;

namespace INTIME.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : INTIMEAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("INTIME",
