...
{
    public class SessionAppService : INTIMEAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = INTIMEConsts.Currency,
                        CurrencySign = INTIMEConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = INTIMEConsts.AllowTenantsToChangeEmailSettings,
