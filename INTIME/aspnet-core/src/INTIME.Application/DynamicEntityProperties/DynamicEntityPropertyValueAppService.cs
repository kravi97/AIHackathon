...
using INTIME.DynamicEntityPropertyValues.Dto;

namespace INTIME.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : INTIMEAppServiceBase, IDynamicEntityPropertyValueAppService
    {
