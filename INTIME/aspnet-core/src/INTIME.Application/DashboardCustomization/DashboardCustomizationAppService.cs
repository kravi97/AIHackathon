...
using INTIME.DashboardCustomization.Dto;

namespace INTIME.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : INTIMEAppServiceBase, IDashboardCustomizationAppService
    {
