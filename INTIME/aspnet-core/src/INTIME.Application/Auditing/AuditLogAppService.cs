...
using INTIME.Auditing.Exporting;
...
using EntityHistoryHelper = INTIME.EntityHistory.EntityHistoryHelper;

namespace INTIME.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : INTIMEAppServiceBase, IAuditLogAppService
    {
