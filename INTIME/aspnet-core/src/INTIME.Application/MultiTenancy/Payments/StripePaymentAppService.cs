...
using INTIME.MultiTenancy.Payments.Stripe;
using INTIME.MultiTenancy.Payments.Stripe.Dto;
using Stripe.Checkout;

namespace INTIME.MultiTenancy.Payments
{
    public class StripePaymentAppService : INTIMEAppServiceBase, IStripePaymentAppService
    {
