...
namespace INTIME.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : INTIMEAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<INTIMEDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{INTIMEConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{INTIMEConsts.ConnectionStringName}", constring);
        }
