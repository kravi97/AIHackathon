...
using INTIME.Authorization.Users.Password;
...
using INTIME.Web.Startup.ExternalLoginInfoProviders;

namespace INTIME.Web.Startup
{
    [DependsOn(
        typeof(INTIMEWebCoreModule)
    )]
    public class INTIMEWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public INTIMEWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(INTIMEWebHostModule).GetAssembly());
        }
