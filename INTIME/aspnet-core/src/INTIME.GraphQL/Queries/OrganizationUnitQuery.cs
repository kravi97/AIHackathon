...
using INTIME.Core.Base;
using INTIME.Core.Extensions;
using INTIME.Dto;
using INTIME.Types;

namespace INTIME.Queries
{
    public class OrganizationUnitQuery : INTIMEQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
