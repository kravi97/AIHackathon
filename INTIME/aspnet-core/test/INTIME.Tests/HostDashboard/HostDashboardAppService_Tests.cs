...
using INTIME.MultiTenancy.HostDashboard;
...
namespace INTIME.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(INTIMEDbContext context, SubscriptionPayment subscriptionPayment)
        {
